        ...
        <div className="container">
          <div className="row align-items-center justisfy-content-between">
            <div className="col-md">
              <img
                src="public\assets\Graduation-Handshake.JPG"
        ...
        <div className="container text-center">
          ...
          <div className="row align-items-center justify-content-between text-center">
            <div className="col-md">
              ...
              src = "public\assets\StockiePY.png"
              />
              </a>
              <p className="lead">
          ...
          <div className="row g-4">
            <div className="col-md">
              ...
              <ul className="list-unstyled">
                <li className='text-primary'>Phone: (555) 123-4567</li>
                <li className='text-primary'>Email: jackiewilson@example.com</li>
                <li className='text-primary'>LinkedIn: linkedin.com/in/jackiewilson</li>
              </ul>
            </div>
